...
## API Endpoint
The API endpoint host is [https://test.sundaya.monitored.equipment](https://test.sundaya.monitored.equipment). 
...
Date and time parameters must be expressed in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format and must conform to [RFC3359](https://tools.ietf.org/html/rfc3339) .
    ...
    https://test.sundaya.monitored.equipment/energy/{type}/{period}/{epoch}

e.g. [https:/test.sundaya.monitored.equipment/energy/hsy/period/week/20190210](https:/test.sundaya.monitored.equipment/energy/hsy/period/week/20190210)
...
- __UTC__ time, represented with a trailing `Z` or trailing zero offset `+0000`
    ...
    [https://test.sundaya.monitored.equipment/energy/hsy/period/hour/20190209T0930Z](https://test.sundaya.monitored.equipment/energy/hsy/period/hour/20190209T0930Z "Z signifies time zone as UTC") 
...
- __Local__ time with UTC offset, represented with a trailing `+/-` offset from UTC (e.g. `+0700`) 
    ...
    [https://test.sundaya.monitored.equipment/energy/hsy/period/hour/20190209T1630+0700](https://test.sundaya.monitored.equipment/energy/hsy/period/hour/20190209T1630+0700 "+0700 is JKT offset from  UTC")
