...
--- | --- | --- | --- | ---
`id` | - | string | - | The identifier of a source system which sends data. This identifier is sent as a foreign key in the `sender` attribute in monitoring datasets, to provide traceability and data provenance.
