...
`reporting` | [energy_period](/docs/api.sundaya.monitored.equipment/0/c/Implementation/Datasets/reporting/energy_period)<br>[device_monitoring](/docs/api.sundaya.monitored.equipment/0/c/Implementation/Datasets/reporting/device_monitoring) | `period` | `Energy API`
