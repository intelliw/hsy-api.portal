...
This consumer sends this message to the `analytics.tel_inverter` dataset table in the datawarehouse as an audit log, and to the `monitoring.inverter.dataset` message broker topic for further stream processing.
