...
---               | ---             | ---               | ---
`MINUTE_ENERGY`<br>`QTRHOUR_ENERGY`<br>`HOUR_ENERGY`<br>`TIMEOFDAY_ENERGY`<br>`DAY_ENERGY`<br>`WEEK_ENERGY`<br>`MONTH_ENERGY`               | 2             | 3               | 4


<br>`QUARTER_ENERGY`<br>`YEAR_ENERGY`<br>
`FIVEYEAR_ENERGY`
