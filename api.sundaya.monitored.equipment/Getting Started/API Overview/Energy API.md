...
`harvest`                   | renewable energy generated by solar panels and other sources.<br>**pv.amps** ([mppt](/docs/api.sundaya.monitored.equipment/0/c/Examples/POST/mppt%20POST%20example)) are always positive.
`yield`                     | energy used by end users and appliances.<br>**load.amps** ([mppt](/docs/api.sundaya.monitored.equipment/0/c/Examples/POST/mppt%20POST%20example)) are always negative.
